...
class Skill(BaseModel):
    """
    Describes the skills of the agent.
    """ # noqa: E501
    category_uid: Optional[StrictInt] = None
    class_uid: StrictInt
    category_name: Optional[StrictStr] = None
    class_name: Optional[StrictStr] = None
    annotations: Optional[Dict[str, StrictStr]] = None
    __properties: ClassVar[List[str]] = ["category_uid", "class_uid", "category_name", "class_name", "annotations"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "category_uid": obj.get("category_uid"),
            "class_uid": obj.get("class_uid"),
