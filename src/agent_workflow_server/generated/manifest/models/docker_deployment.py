...
class DockerDeployment(BaseModel):
    ...
    image: StrictStr = Field(description="Container image built for the agent containing the agent and Workflow Server.")
    __properties: ClassVar[List[str]] = ["type", "name", "image"]
