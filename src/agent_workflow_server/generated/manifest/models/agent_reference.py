...
class AgentReference(BaseModel):
    """
    Reference to the agent in the agent directory. It includes the version and the locator.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AgentReference from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AgentReference from a dict"""
        if obj is None:
            return None
