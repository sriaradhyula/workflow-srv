...
class EnvVarValues(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "values", "dependencies"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "dependencies": [EnvVarValues.from_dict(_item) for _item in obj.get("dependencies")] if obj.get("dependencies") is not None else None
        })
        return _obj
