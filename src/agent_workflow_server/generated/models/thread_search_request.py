...
class ThreadSearchRequest(BaseModel):
    ...
    """ # noqa: E501
    agent_id: Optional[StrictStr] = Field(default=None, description="Matches all threads associated with the specified agent ID.")
    ...
    __properties: ClassVar[List[str]] = ["agent_id", "metadata", "limit", "offset"]
