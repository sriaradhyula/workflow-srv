...
class RunWaitResponseStateless(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "run": RunStateless.from_dict(obj.get("run")) if obj.get("run") is not None else None,
            "output": RunOutput.from_dict(obj.get("output")) if obj.get("output") is not None else None
        })
        return _obj
